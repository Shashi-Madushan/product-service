package lk.ijse.eca.programservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleProductNotFound(
        ...
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.NOT_FOUND, "Product Not Found", ex.getMessage(), request.getRequestURI());
        return problemResponse(HttpStatus.NOT_FOUND, problem);
    }

    @ExceptionHandler(DuplicateProductException.class)
    public ResponseEntity<ProblemDetail> handleDuplicateProduct(
            DuplicateProductException ex, HttpServletRequest request) {
        log.warn("Duplicate product: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT, "Duplicate Product", ex.getMessage(), request.getRequestURI());
